defmodule WemachatDatabase.Schemas.GroupPostComment do
  @moduledoc """
  Schema for threaded comments on group posts.
  Supports unlimited nesting with path/depth tracking.
  All group members (including subscribers) can comment.
  """
  use Ecto.Schema
  import Ecto.Changeset

  alias WemachatDatabase.Schemas.{GroupPost, GroupPostComment}
  ...
  schema "group_post_comments" do
    ...
    belongs_to :post, GroupPost, foreign_key: :post_id
    belongs_to :parent, GroupPostComment, foreign_key: :parent_id
    has_many :replies, GroupPostComment, foreign_key: :parent_id
